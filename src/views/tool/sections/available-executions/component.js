import {Box, Card, CardContent, CardHeader, Grid, IconButton, List, ListItem, ListItemText, Typography} from '@material-ui/core';
...
const ToolExecutionItem = ({createdAt, id, name, progress, state, applicationId, toolId}) => {
    ...
    return (
        <ListItem
            button
            component={NavLink}
            to={`/applications/${applicationId}/tools/${toolId}/available-executions#${id}`}
        >
            <ListItemText
                primary={itemText}
